<template>
  <div class="container">
    <h1 class="titlePage" v-scroll-reveal>Mentions Légales</h1>

    <p v-scroll-reveal style="text-align:justify">
      ...
      <a
        href="http://polytweet.fr"
        target="_blank"
      >polytweet.fr</a> les informations suivantes :
    </p>

    <p v-scroll-reveal style="text-align:justify;text-decoration:underline;">
    ...
    <p v-scroll-reveal style="text-align:justify">
      ...
      <br />Le Propriétaire est :
      <strong>Polytweet</strong>
      <br />Adresse postale du propriétaire :
      <strong>15 Boulevard André Latarjet, 69100 Villeurbanne 691000 Villeurbanne</strong>
      <br />
      <br />Le Créateur du site est :
      <strong>Polytweet Group</strong>
      <br />Le Responsable de la publication est :
      <strong>Poly Tweet</strong>
      <br />Contacter le responsable de la publication :
      <strong>Polytweet@gmail.com</strong>
      <br />Le responsable de la publication est une
      <strong>personne physique</strong>
      <br />
      <br />Le Webmaster est :
      <strong></strong>
      <br />Contacter le Webmaster :
      <strong>
        <a
          href="mailto: polytweetDev@gmail.com?subject=Contact a partir des mentions lÃ©gales via le site polytweet.fr"
        >polytweetDev@gmail.com</a>
      </strong>
      <br />L’hebergeur du site est :
      <strong>http://polytweet.fr/ 15 Boulevard André Latarjet 69000 Lyon</strong>
      <br />
    </p>

    <p v-scroll-reveal style="text-align:justify"></p>
    <br />
    <p v-scroll-reveal style="text-align:justify;text-decoration:underline;">
    ...
    <p v-scroll-reveal style="text-align:justify">
      ...
      <strong>Utilisateur</strong>, tout internaute se connectant et utilisant le site susnommé :
      <a
        href="http://polytweet.fr"
        target="_blank"
      >polytweet.fr</a>.
      <br />Le site
      <strong>polytweet.fr</strong>
      ...
      <br />Polytweet s’efforce de fournir sur le site polytweet.fr des informations les plus précises possibles (sous réserve de modifications apportées depuis leur mise en ligne), mais ne saurait garantir l'exactitude, la complétude et l'actualité des informations diffusées sur son site, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent ces informations. En conséquence, l'utilisateur reconnaît utiliser ces informations données (à titre indicatif, non exhaustives et susceptibles d'évoluer) sous sa responsabilité exclusive.
    </p>

    <p v-scroll-reveal style="text-align:justify"></p>
    <br />
    <p v-scroll-reveal style="text-align:justify">
      <strong style="text-decoration:underline;">3. Accessibilité :</strong>
      <br />
      <br />Le site polytweet.fr est par principe accessible aux utilisateurs 24/24h, 7/7j, sauf interruption, programmée ou non, pour les besoins de sa maintenance ou en cas de force majeure. En cas d’impossibilité d’accès au service, polytweet.fr s’engage à faire son maximum afin de rétablir l’accès au service et s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures de l’intervention. N’étant soumis qu’à une obligation de moyen, polytweet.fr ne saurait être tenu pour responsable de tout dommage, quelle qu’en soit la nature, résultant d’une indisponibilité du service.
    </p>

    <p v-scroll-reveal style="text-align:justify"></p>
    <br />
    <p v-scroll-reveal style="text-align:justify">
      <strong style="text-decoration:underline;">4. Propriété intellectuelle :</strong>
      <br />
      <br />Polytweet est propriétaire exclusif de tous les droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur le site, tant sur la structure que sur les textes, images, graphismes, logo, icônes, sons, logiciels…
      <br />Toute reproduction totale ou partielle du site polytweet.fr, représentation, modification, publication, adaptation totale ou partielle de l'un quelconque de ces éléments, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de Polytweet, propriétaire du site à l'email : polytweetDev@gmail.com, à défaut elle sera considérée comme constitutive d’une contrefaçon et passible de poursuite conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.
    </p>

    <p v-scroll-reveal style="text-align:justify">
      <br />
      <strong style="text-decoration:underline;">5. Liens hypertextes et cookies :</strong>
      <br />
      <br />Le site polytweet.fr contient un certain nombre de liens hypertextes vers d’autres sites (partenaires, informations …) mis en place avec l’autorisation de Polytweet. Cependant, Polytweet n’a pas la possibilité de vérifier l'ensemble du contenu des sites ainsi visités et décline donc toute responsabilité de ce fait quand aux risques éventuels de contenus illicites.
      <br />L’utilisateur est informé que lors de ses visites sur le site polytweet.fr, un ou des cookies sont susceptibles de s’installer automatiquement sur son ordinateur par l'intermédiaire de son logiciel de navigation. Un cookie est un bloc de données qui ne permet pas d'identifier l'utilisateur, mais qui enregistre des informations relatives à la navigation de celui-ci sur le site.
      <br />Le paramétrage du logiciel de navigation permet d’informer de la présence de cookie et éventuellement, de la refuser de la manière décrite à l’adresse suivante :
      <a
        href="http://www.cnil.fr"
      >www.cnil.fr</a>. L’utilisateur peut toutefois configurer le navigateur de son ordinateur pour refuser l’installation des cookies, sachant que le refus d'installation d'un cookie peut entraîner l’impossibilité d’accéder à certains services. Pour tout bloquage des cookies, tapez dans votre moteur de recherche : bloquage des cookies sous IE ou firefox et suivez les instructions en fonction de votre version.
    </p>
    ...
    <p v-scroll-reveal style="text-align:justify">
      ...
      >6. Protection des biens et des personnes - gestion des données personnelles :</strong>
      <br />
    ...
    <p v-scroll-reveal style="text-align:justify">
      ...
      <strong>
        <a
          href="mailto: polytweetDev@gmail.com?subject=Contact ï¿½ partir des mentions lï¿½gales via le site polytweet.fr"
        >Polytweet@gmail.com</a>
      </strong> ou par écrit dûment signée, accompagnée d’une copie du titre d’identité avec signature du titulaire de la pièce, en précisant l’adresse à laquelle la réponse doit être envoyée.
    </p>
    ...
    <p v-scroll-reveal style="text-align:justify">
      ...
      <br />Le site polytweet.fr est en conformité avec le RGPD voir notre politique RGPD http://polytweet.fr/.
    </p>
